                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text("Flutter With UzairLeo", style: TextStyle(fontSize: kIsWeb ? 64 : 32, fontWeight: FontWeight.w700, color: Colors.lightBlue),),
                          SizedBox(height: 8,),
                          Text("UzairLeo makes it easy for every one to dessiminate knowledge, and making "
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text("Flutter With Uzairleo", style: TextStyle(fontSize: 64, fontWeight: FontWeight.w700, color: Colors.lightBlue),),
                                SizedBox(height: 8,),
                                Text("UzairLe0 makes it easy for every one to dessiminate knowledge, and making "
                                    "difficult problems easy to solve", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w300, letterSpacing: 1.0, color: Colors.grey[800]),),
                                SizedBox(height: 16,),
